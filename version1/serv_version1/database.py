...
# This is the key used to encrypt everything. Leaking this is bad.
...
class Database(object):
    ...
    def __close_db_conn(self, uname):
        '''
        Closes the connection (if open) to parameter sers database.
        '''
        try:
    ...
    def __read_passwords(self, conn, uname):        
        ...
        self.__logger.debug("We are reading user "+uname+"'s passwords:")
        result = {}
